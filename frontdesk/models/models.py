...
class frontdesk(models.Model):
    ...
    def push_to_crm(self):
        ...
        for lead in self:
            ...
            # Mapping for 'final' field to its display value
            final_display = dict(lead._fields['final'].selection)
            ...
            crm_lead_vals = {
                ...
                'final_status': final_display.get(lead.final),  # Correctly assigning the display value
