...
class project_tb_custom(models.Model):
    ...
    adj_dr_amount = fields.Float(string='Adjustmemt Entries - DR Amount')
    adj_cr_amount = fields.Float(string='Adjustmemt Entries - CR Amount')
    final_balance = fields.Float(string='Final Balance')
    adj_remarks = fields.Char(string='Remarks')
