...
class CrmLead(models.Model):
    ...
    def create(self, values):
        ...
        # Find the user record for Neil Antony Pinheiro
        ...
        if user.email == 'neil@analytix.org':
            # Assign Neil Antony Pinheiro as the salesperson
            ...
            for field_name, field in self._fields.items():
                if field.required and field_name not in values:
                    raise UserError(f"Field '{field_name}' is mandatory and must be set.")
