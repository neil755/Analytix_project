...
class EXTTracker(models.Model):
    ...
    nature_work = fields.Many2many('ext.tracker.nature', string="Assigned To", tracking=True)
    ...
    payment_status = fields.Many2one('ext.tracker.payment.status', tracking=True)
    ...
    work_status = fields.Many2one('ext.tracker.status', string='Contract Status', tracking=True)
