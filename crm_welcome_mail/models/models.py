...
class CrmLead(models.Model):
    ...
    def send_welcome_email(self, lead):
        ...
        email_body = f"""
            ...
            <p>My name is {mail_data.salesperson_name.name or 'Sreelekha'}, and I am your dedicated consultant at Analytix Management Consultancy. Thank you for considering us as your trusted partner in achieving your business goals. Your inquiry means a lot to us, and we are excited about the opportunity to collaborate with you.</p>
            <p>What's Next? </p>
            <p>We'll get back to you within the next 8 working hours to better understand your needs and provide tailored solutions. In the meantime, here's a quick overview of how we can support your business:</p>
            <ul>
            ...
            <p>You can learn more about our expertise by visiting our website: analytix.sa . Additionally, I've attached our Business Profile for your reference.</p>
            <p><strong>Why Choose Analytix?</strong></p>
            <p>With 15+ years of experience, a presence in 8+ countries , and a team of 100+ experts , we deliver end-to-end solutions tailored to your needs. Whether you're starting a new venture or scaling an existing one, we're here to guide you every step of the way.</p>
